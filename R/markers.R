...
##' Arabodopsis and Dr Claire Mulvey for mouse.
##' In addition, markers from the \code{pRolocdata} datasets
##' have been extracted. See \code{pRolocdata} for details and
##' references.
##'
