...
#' @param method The current infernece method for the TAGM algorithm. Default is \code{"MAP"}     
...
#' @param S0 The prior inverse-wishary scale matrix. Empirical prior used by default.
...
tagmPredict <- function(object,
  ...
  #get parameters from
  posteriors <- MAPparams@posteriors
