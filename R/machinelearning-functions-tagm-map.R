...
##'
##' The `tagmTrain` function generates the MAP parameters (object or
##' class `MAPParams`) based on an annotated quantitative spatial
...
##' @return `tagmTrain` returns an instance of class [MAPParams()].
##' @md
...
##'     joint probability, i.e. the probability for all classes as a
...
##'     a new `tagm.allocation` feature variable.
##' @md
##' @rdname tagm-map
