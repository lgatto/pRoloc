...
classification a-posteriori probability to set the point size (figure \@ref(fig:plothl)).

```{r plothl, fig.asp=1, echo=FALSE, fig.cap="The results of a class-weight SVM classification on LOPIT data produced from mouse embryonic stem cells."}
