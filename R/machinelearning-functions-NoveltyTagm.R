...
##' model for mass spectrometry-based spatial proteomics datasets with
##' added Novelty detection
##' using Markov-chain Monte-Carlo (MCMC) for inference. New classes for
##' NoveltyProcess needed to be added.
