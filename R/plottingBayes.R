...
##' @param dims The PCA dimension in which to project he data, default is \code{c(1,2)}
...
##' @param object A valid object of class \code{MSnset} with mcmc prediction results from \code{tagmMCMCpredict}
##' @param dims The PCA dimension in which to project he data, default is \code{c(1,2)}
##' @param cov.function The covariance function used default is wendland.cov. See \code{fields} package.
##' @param theta A hyperparameter to the covariance function. See \code{fields} package. Default is 1.
##' @param derivative The number of derivative of the wendland kernel. See \code{fields} package. Default is 2.
##' @param k A hyperparamter to the covariance function. See \code{fields} package. Default is 1.
##' @param breaks Probability values at which to draw the contour bands. Default is \code{c(0.99, 0.95, 0.9, 0.85, 0.8, 0.75, 0.7)}
##' @param aspect A argument to change the plotting aspect of the PCA
##' @return Used for side effect of producing plot. Invisibily returns an ggplot object
##' that can be further manipulated
##' @author Oliver M. Crook <omc25@cam.ac.uk>
