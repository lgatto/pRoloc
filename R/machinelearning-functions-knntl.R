...
##' @param method The k-NN transfer learning method to use. The default
...
##' Learning from heterogeneous data sources: an application 
##' in spatial proteomics. bioRxiv. doi: http://dx.doi.org/10.1101/022152
##' 
