...
##'
##' Version 1 of the markers have been contributed by various
...
##' Hutchings from the Cambridge Centre for Proteomics. Reference species 
##' marker sets are the same as those in version 1 with minor corrections and
##' an updated naming system. Version 2 also contains additional marker sets
