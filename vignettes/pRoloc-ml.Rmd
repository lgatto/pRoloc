...
The [figure below](#fig:ISL1) uses 2 $\times$ 100 simulated data
...
*algOptimization*. See table \@ref(tab:mltab) for details. A
description of each of the respective model parameters is provided in
...
kable(tab)
``` 
Table:(\#tab:mltab) Machine learning methods in *pRoloc*.
