...
##' returns a list with the PCA analsys results (see
##' \code{\link{prcomp}}) of the first data set and the new
##' coordinates of the second data sets, as used to produce the plot.
##' @author Laurent Gatto
##' @seealso See \code{\link{plot2D}} to plot a single data set.
##' @examples
##' library("pRolocdata")
##' data(tan2009r1)
##' data(tan2009r2)
